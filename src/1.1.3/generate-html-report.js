...
<body>
    ...
    <script>
        ...
        new Chart(document.getElementById('geoChart'), {
            ...
            options: { ...chartDefaults, plugins: { legend: { position: 'right', labels: { color: '#f1f1f1' }}}}
        });
                ...
                plugins: {
                    legend: { 
                        ...
                        labels: { 
                            color: '#f1f1f1',
                            generateLabels: () => [
                                { text: 'White Papers: High (75-100%)', fillStyle: '#00d4aa', strokeStyle: '#00d4aa', lineWidth: 2 },
                                { text: 'White Papers: Medium (50-75%)', fillStyle: '#fca311', strokeStyle: '#fca311', lineWidth: 2 },
                                { text: 'White Papers: Low (25-50%)',  fillStyle: '#e94560', strokeStyle: '#e94560', lineWidth: 2 },
                                { text: 'White Papers: Minimal (0-25%)', fillStyle: '#533483', strokeStyle: '#533483', lineWidth: 2 },
                            ]
                        }
                    },
                    tooltip: {
